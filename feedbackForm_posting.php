<?php
    ...
    else //Connection Successful
    {
        if(!$loggedIn){
            ...
            if(mysqli_num_rows($result1) == 0) 
            {
                ...
                {                
                    $query = "INSERT INTO $sql_table (customer_id, type, name, email, phone, reason, description, report_date) 
                        VALUES ('-1', 'feedback', '$name', '$email', '$phone', '$feedbackType', '$dateOfFeedback')";
            ...
            {
                $query = "INSERT INTO $sql_table (customer_id, type, name, email, phone, reason, description, report_date) 
                    VALUES ('-1', 'feedback', '$name', '$email', '$phone', '$feedbackType', '$feedbackDesc', '$dateOfFeedback')";
            ...
            if(mysqli_num_rows($result3) == 0) 
            {
                ...
                {                
                    $query = "INSERT INTO $sql_table (customer_id, type, name, email, phone, reason, description, report_date) 
                        VALUES ('$userID', 'feedback', '$name', '$email', '$phone', '$feedbackType', '$dateOfFeedback')";
            ...
            {
                $query = "INSERT INTO $sql_table (customer_id, type, name, email, phone, reason, description, report_date) 
                    VALUES ('$userID', 'feedback', '$name', '$email', '$phone', '$feedbackType', '$feedbackDesc', '$dateOfFeedback')";
