...
<head>
  ...
  <title>User Login - The Book Spot</title>
...
<body>
  ...
  <h1 class="loginTitle">User Login</h1>
    <form method="post" action="inc/loginUser.inc.php" novalidate>
      ...
      ?>
        ...
        <div class="txt_field">
            ...
            <input class="login" type="submit" name="loginUser" value="Login">
            <a class="signup" href="signupUser.php">Signup</a>
    </form>
    </div>
  </body>
  </html>
