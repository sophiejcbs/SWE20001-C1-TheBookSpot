...
<body>
    ...
    <!-- Back button -->
    <div class="backContainer_et">
        <a href="javascript:history.back()"><i class="bi bi-arrow-left text-dark"></i></a>
    </div>

    <!-- Details -->
    <div class="bookContainer_et">
        <!-- Book Image -->
        <div class="imageContainer_et"><img src = "<?php echo $image?>"></div>
        <div class="infoContainer_et">
